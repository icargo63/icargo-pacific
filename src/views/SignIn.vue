          ...
          >
            <form style="width: 23rem">
              ...
              <div class="form-outline mb-4">
                <button
                  type="button"
                  class="btn btn-warning btn-md m-2 text-white"
                  style="width: 20rem"
                >
                  <router-link class="route" to="/customer-sign-in"
              ...
              <div class="form-outline mb-4">
                <button
                  ...
                  style="width: 20rem"
                >
                  <router-link class="route" to="/merchant-sign-in"
              ...
              <div class="form-outline mb-4">
                <button
                  ...
                  style="width: 20rem"
                >
                  <router-link class="route" to="/partner-sign-in" exact
                    >Partner</router-link
                  >
                </button>
              </div>
              ...
              <div class="pt-1 mb-4 d-flex justify-content-center">
                ...
                <router-link class="nav text-warning" to="/sign-in">
                  Sign in</router-link
                >
              </div>
